...
export default function ChatPreview() {
  // Use state to manage chats, allowing for updates
  const [chats, setChats] = useState<Chat[]>(chatsData);

  // Handler function to mark all chats as read
  const handleMarkAllAsRead = () => {
    const updatedChats = chats.map(chat => ({ ...chat, unreadCount: 0 }));
    setChats(updatedChats);
  };

  // Sort chats: unread first, then by most recent timestamp
            ...
            >
              <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5 bg-white border border-gray-200">
                ...
                <div className="max-h-96 overflow-y-auto">
                  {/* Map over the sorted, state-managed chats */}
                ...
                <div className="p-3 flex justify-between items-center bg-white">
                  <a href="#" className="text-sm font-semibold text-black underline">
                    View all
                  </a>
                  <ProgressLink
